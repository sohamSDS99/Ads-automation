"""4.5.1 `landing_message_match` — a stub until its build phase (Stage 04 PRD §11, §21.3).

Landing-page H1 vs ad headline as a measured score, with a linted fix.
...
LANDING_MESSAGE_MATCH = stub(
    "4.5.1",
    "landing_message_match",
    depends_on=("4.2.3",),
